...
if (isset($_POST["resetPassword"])) {
  ...
  if (mysqli_num_rows($check_email) > 0) {
      ...
      <p><a href='{$base_url}reset-password.php?phoneno={$data['phoneno']}'>Reset Password</a></p>
      </body>
      </html>
      ";
  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
        <form action="" method="post" class="sign-in-form">
          ...
          <input type="submit" value="Send Verification Link" name="resetPassword" class="btn" />
          <p style="display: flex;justify-content: center;align-items: center;margin-top: 20px;"><a href="login_SignIn.php" style="color: #000000;">Back</a></p>
        </form>
      </div>
    </div>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        ...
        <img src="images/forgotpassword.svg" class="image" alt="" />
      </div>
    </div>
  </div>
