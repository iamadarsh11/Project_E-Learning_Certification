...
<body style="">
  ...
  <div class="container mt-4 col-md-10 position-relative">
    <h3 align='center' style="font-family: 'Catamaran', sans-serif;">Welcome ,Lets start the Final test</h3>
   ...
   <?php $quize_course_name=$_GET['course_name']; ?>
     <center><a  class="btn btn-success mt-5" href="final_test_question_show.php?course_name=<?php echo $quize_course_name ;?>" >Start Test</a></center>
 ...
 ?>
      ...
      <button type="submit" class="btn btn-success mt-3">Start Test</button>
  </form> -->
  </div>
</div>
</div>
