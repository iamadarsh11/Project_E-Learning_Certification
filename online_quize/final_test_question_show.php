 <!-- navigation bar starts -->
  ...
  <a class="navbar-brand text-white" href="../index.php">JustASSK</a>
...
$ques=new users;
$cat= $_GET['course_name'];

$_SESSION['course_name']=$cat;
echo "<pre>";
...
<div class="container position-relative" style="text-align: center; margin-top: -380px;">
  ...
  <form action="final_test_result_show.php" method="POST" id="myform" style="margin-top: -400px;">
  
<center><div class="row col-sm-7 ">
  <script type="text/javascript">
      var timeleft=30*60;                                   //important--> the scope of javascript variable is global but not in php(we have to use global keyword)
